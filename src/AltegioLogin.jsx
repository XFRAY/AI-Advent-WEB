  ...
  return <Paper variant="outlined" sx={{ p: { xs: 1.5, sm: 2 }, flexShrink: 0,  overscrollBehavior: 'contain' }}>
    ...
    {status?.authenticated ? <Stack spacing={2}>
      ...
      <Stack direction="column" sx={{ gap: 2 }}>
        ...
        <TextField size="small" fullWidth required label="Пароль" type="password" autoComplete="current-password" value={password} onChange={e => setPassword(e.target.value)} disabled={busy || pending} slotProps={{ htmlInput: { maxLength: 1024 } }} />
